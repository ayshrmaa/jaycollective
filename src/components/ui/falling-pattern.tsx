...
// Local stand-in for shadcn's cn() — this project has no @/lib/utils.
...
export function FallingPattern({
  ...
  const generateBackgroundImage = () => {
    ...
    return rows
      .flatMap(([streak, dot]) => [
        `radial-gradient(4px 100px at 0px ${streak}px, ${color}, transparent)`,
        `radial-gradient(4px 100px at 300px ${streak}px, ${color}, transparent)`,
        `radial-gradient(1.5px 1.5px at 150px ${dot}px, ${color} 100%, transparent 150%)`,
      ])
      .join(', ')
  }
